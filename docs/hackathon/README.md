...
3. **이번 3단계 — 서비스 검증:** [교육 계정 검증](../AWS_EDU_VALIDATION.md). 콘솔 얼굴 검출·비교 확인, 합성 데이터·자동 실행기 및 [EC2 인계용 컨테이너](../AWS_VALIDATION_CONTAINER.md) 준비. 앱 역할의 S3·Rekognition·AWS 배포와 실사진·여러 기기·복원·처리량 검증은 남아 있음.
